...
def get_supabase_client() -> Client:
    ...
    if SUPABASE_KEY == "your-anon-key-here":
        raise ValueError("Please update SUPABASE_KEY in .env with your actual Supabase anon key")
...
def main():
    ...
    if SUPABASE_KEY == "your-anon-key-here":
        print("❌ Error: Please update SUPABASE_KEY in .env with your actual anon key")
        sys.exit(1)
