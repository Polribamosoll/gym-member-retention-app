...
TRANSLATIONS = {
    ...
    "es": {
        ...
        "model_step_1": "📊 Recopilación de Datos: Observamos información de los miembros como fechas de registro, tipos de membresía y patrones de visitas.",
        "model_step_2": "🔍 Reconocimiento de Patrones: La IA aprende de datos pasados para identificar qué comportamientos suelen llevar a que los miembros se vayan (abandono).",
        "model_step_3": "🎯 Predicción de Riesgo: Para cada miembro activo, la IA calcula una puntuación de riesgo de Bajo a Alto basada en su actividad reciente.",
        "model_step_4": "📈 Información Accionable: Obtienes una lista priorizada de miembros en los que enfocar tus esfuerzos de retención, ahorrando tiempo y dinero.",
    ...
    "ca": {
        ...
        "model_step_1": "📊 Recopilació de Dades: Observem informació dels membres com dates de registre, tipus de membresía i patrons de visites.",
        "model_step_2": "🔍 Reconeixement de Patrons: La IA aprèn de dades passades per identificar quins comportaments solen portar a que els membres se'n vagin (abandó).",
        "model_step_3": "🎯 Predicció de Risc: Per cada membre actiu, la IA calcula una puntuació de risc de Baix a Alt basada en la seva activitat recent.",
        "model_step_4": "📈 Informació Accionable: Obtens una llista prioritzada de membres en els que enfocar els teus esforços de retenció, estalviant temps i diners.",
