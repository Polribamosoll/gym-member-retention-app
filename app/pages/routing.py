...
def show_routing_page(show_navigation_bar, navigate_to):
    ...
    if st.session_state.routes_optimized:
        ...
        st.plotly_chart(fig, width='stretch', key="truck_utilization_chart")
        ...
        with col_r1:
            ...
            st.plotly_chart(fig, width='stretch', key="route_distance_chart")
        
        with col_r2:
            fig = create_distance_vs_stops_chart(routes, deliveries)
            st.plotly_chart(fig, width='stretch', key="distance_vs_stops_chart")
